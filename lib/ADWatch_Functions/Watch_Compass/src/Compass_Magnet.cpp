...
Synopsis: Compass_Magnet: The means of moving a compass needle, index determiner 
		for the compass
...
/** updateHeading()
  ...
  @postcond: Heading curHeading attribute has been updated
   ...
   @Param: newHeading - a float representing the direction we will update our 
						heading to
...
/** getHeadingIndex()
  ...
  @ Synopsis: Takes in a floating point heading in range [0,360] and produces 
			 the array offset [0,11] that it maps to. In intervals of 30 degrees
